...
export const PharmacyTable: React.FC = () => {
  ...
  return (
    <Card title="Central de Performance das Farmácias" className="h-full">
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-gray-50">
              <th className="pb-3 text-[10px] font-bold text-brand-teal uppercase tracking-wider pl-2">Farmácia</th>
